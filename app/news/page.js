            ...
            <div className="grid md:grid-cols-2 grid-cols-1 mb-14">
              ...
              <div className="p-5">
                ...
                <div className="mb-5 w-[100%]">
                  ...
                  <p className="w-[100%] text-sm px-3">
                    Pada hari Minggu tanggal 4 Desember 2017 telah diadakan perkuliahan ke tiga (3) yang bertempat di Ruang Sidang Pascasarjana UNTIRTA, di Gedung Pascasarjana UNTIRTA Lantai 2. Acara perkuliahan berlangsung dari pukul 08.00
                    WIB hingga selesai pukul 12.00 WIB.
                  </p>
                </div>
                <a href="#" className="bg-gray-300 p-2 border-b border-black rounded-md hover:bg-gray-400 active:bg-gray-500 active:text-white duration-200">
                  Continue Reading
