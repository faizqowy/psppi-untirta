    ...
    <div style={{ backgroundColor: "white", width: "78%", margin: "auto", padding: "20px" }}>
      ...
      <section className="p-8 bg-white text-gray-600">
        ...
        <header className=" page-header" style={headerStyle}>
          <h1 className="page-title text-base leading-normal  font-bold  border-l-4 border-solid border-transparent pl-2 pt-1 pb-1 pr-4 bg-gray-100 border-blue-500 ">Category: news</h1>
        </header>
