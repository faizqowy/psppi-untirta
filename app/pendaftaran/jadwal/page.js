          ...
          <section className="my-4 p-8 bg-white text-gray-600">
            ...
            <ul className="list-decimal pl-10 my-4">
              ...
              <p className="mu-3 mb-3">
                Pelaksanaan Tes Wawancara tiap calon mahasiswa dilaksanakan 1
                hari kurang lebih selama 30 menit:
              </p>
              ...
              <table
                ...
                <tbody>
                  ...
                  <tr>
                    <td className="border p-2 font-bold" colSpan="3">
                      Verifikasi biodata (secara online dan harus datang ke
                      BAKPM)
                    </td>
                  </tr>
              ...
              <p className="mu-3 mb-3">
                ...
                biaya Program Profesi Insinyur (PPI) sebesar Rp. 12.500.000,-
                (dua belas juta lima ratus ribu rupiah). Biaya PPI sudah
                termasuk biaya pendaftaran keanggotaan PII (Persatuan Insinyur
                Indonesia) dan iuran tahun pertama. Biaya Sertifikasi Insinyur
                Profesional Pratama (IPP), Sertifikasi Insinyur Profesional
                Madya (IPM) atau Sertifikasi Insinyur Profesional Utama
                ditanggung sendiri oleh mahasiswa dengan besaran mengacu pada
                biaya di Persatuaan Insinyur Indonesia (PII), yang dibayarkan
